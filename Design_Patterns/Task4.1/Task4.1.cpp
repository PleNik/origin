...
//нарушение Interface segregation principle: Printable не является узкоспецализированным, не заточен под конкретную задачу
//нарушение Liskov substitutation principle: использование функций printAsHTML(), printAsText(), printAsJSON() с экземпляром Data приведет к исключению
//нарушение Open-closed principle: при добавлении нового формата необходимо вносить изменения и в базовый класс, и в наследник, создавать новую функцию saveToAsNewFormat
